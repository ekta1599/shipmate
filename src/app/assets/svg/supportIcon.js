...
const SupportIcon = () => {
  return (
    <>
      ...
      >
        <path
          d="M18 18.86H17.24C16.44 18.86 15.68 19.17 15.12 19.73L13.41 21.42C12.63 22.19 11.36 22.19 10.58 21.42L8.87 19.73C8.31 19.17 7.54 18.86 6.75 18.86H6C4.34 18.86 3 17.53 3 15.89V4.97999C3 3.33999 4.34 2.00999 6 2.00999H18C19.66 2.00999 21 3.33999 21 4.97999V15.89C21 17.52 19.66 18.86 18 18.86Z"
          stroke="#47A7FF"
          strokeWidth="1.5"
          strokeMiterlimit="10"
          strokeLinecap="round"
